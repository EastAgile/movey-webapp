...
fn test_base_url() {
    ...
    assert_eq!(
        url.as_str(),
        format!("https://secure.gravatar.com/avatar/5658ffccee7f0ebfda2b226238b1eb6e?s=200&d={}&r=pg",DEFAULT_AVATAR_STYLE)
    );
}
...
fn test_size() {
    ...
    assert_eq!(
        url.as_str(),
        format!("https://secure.gravatar.com/avatar/5658ffccee7f0ebfda2b226238b1eb6e?s=50&d={}&r=pg",DEFAULT_AVATAR_STYLE)
    );
}