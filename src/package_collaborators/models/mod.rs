...
use crate::schema::package_collaborators::dsl::*;
...
impl PackageCollaborator {
    pub async fn new_collaborator(
        ...
        diesel::insert_into(package_collaborators)
    ...
    pub async fn get(package_id_: i32, account_id_: i32, pool: &DieselPgPool) -> Result<Self, Error> {
        Ok(package_collaborators
